...
typedef enum {
    ...
    EVENT_BIOMETRIC_FAIL      = 0x1D,
    EVENT_CRYPTO_FAIL         = 0x1E,

    EVENT_VM_VERIFY_START = 0x20,
    EVENT_VM_VERIFY_OK = 0x21,
    EVENT_VM_SIG_FAIL = 0x22,
    EVENT_VM_BUS_PUB = 0x23,
    EVENT_VM_EXT_MOUNT = 0x24,
    EVENT_VM_REFLEX = 0x25,
    EVENT_VM_HALT = 0x26,
    EVENT_VM_OP_INIT = 0x27,
    EVENT_VM_IDENTITY_REGEN = 0x28,
    EVENT_VM_LUME_VOICE = 0x29,
